...
import static christmas.order.OrderRequest.ERROR_INVALID_DATE;
...
class OrderRequestTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"양송이수프-1", "티본스테이크-5", "초코케이크-10", "제로콜라-3"})
    ...
    @ParameterizedTest
    @ValueSource(strings = {"양송이스프-1,양송이스프-1", "제로콜라-1,양송이스프-1,제로콜라-1"})
